                            ...
                            @if(isset($donasiMasukList) && $donasiMasukList->count())
                                @foreach($donasiMasukList as $dm)
                                    <tr>
                                        ...
                                        <td style="font-weight:600;color:#d4537e;">
                                            Rp.{{ number_format($dm->nilai_dana, 0, ',', '.') }}
                                            @if($dm->is_barang)
                                                <div style="font-size:11px;color:#999;font-weight:400;">{{ $dm->label_jumlah }}</div>
                                            @endif
                                        </td>
                                        <td style="text-align:center;">
                            ...
                            @if(isset($donasiKeluarList) && $donasiKeluarList->count())
                                @foreach($donasiKeluarList as $dk)
                                    <tr>
                                        ...
                                        <td style="font-weight:600;color:#4361ee;">
                                            Rp.{{ number_format($dk->nilai_dana, 0, ',', '.') }}
                                            @if($dk->is_barang)
                                                <div style="font-size:11px;color:#999;font-weight:400;">{{ $dk->label_jumlah }}</div>
                                            @endif
                                        </td>
                                        <td style="text-align:center;">
