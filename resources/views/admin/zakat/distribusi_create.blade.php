...
<div class="form-box">
    ...
    <p class="form-subtitle">Catat penyaluran zakat ke mustahik dengan pilihan distribusi uang atau barang. Hubungkan ke penerimaan zakat bila distribusi berasal dari transaksi tertentu.</p>
    <form action="{{ route('zakat.distribusi.store') }}" method="POST" id="formDistribusi">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <span class="field-note"><i class="fa fa-info-circle"></i> Opsional. Gunakan jika distribusi ini berasal dari penerimaan zakat tertentu.</span>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row-single" id="nominalFieldDistribusi">
                <div class="form-group">
                    ...
                    <input type="text" id="nominalDisplay" oninput="formatNominalRupiah(this)" placeholder="Contoh: 250.000">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <textarea name="keterangan" id="keteranganDistribusi" placeholder="Tambahkan catatan penyaluran bila diperlukan...">{{ old('keterangan') }}</textarea>
            </div>
        </div>
