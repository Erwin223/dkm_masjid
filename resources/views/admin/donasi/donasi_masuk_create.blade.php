    ...
    <form action="{{ route('donasi.masuk.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="donatur_id" id="donaturSelect" onchange="pilihDonatur()">
                    ...
                    @foreach($donaturList as $don)
                        <option value="{{ $don->id }}"
                            ...
                            {{ old('donatur_id') == $don->id ? 'selected' : '' }}>
                ...
                <div style="margin-top:6px;font-size:12px;color:#999;">
                    ...
                    <input type="text" name="donatur_nama" id="donaturNama"
                        value="{{ old('donatur_nama', 'Hamba Allah') }}"
        ...
        <div class="form-group">
            ...
            <div style="position:relative;">
                ...
                <input type="text" id="jumlahDisplay" placeholder="0" required style="padding-left:32px;"
                    oninput="formatRupiah(this,'jumlahHidden')">
            </div>
            <input type="hidden" name="jumlah" id="jumlahHidden" value="{{ old('jumlah', 0) }}">
            <input type="hidden" name="total" id="totalHidden" value="{{ old('jumlah', 0) }}">
...
function pilihDonatur() {
    ...
    if (sel.value) {
        ...
        info.innerHTML = '<i class="fa fa-circle-check" style="color:#0f8b6d;"></i> <b>' + opt.dataset.nama + '</b> (' + jenis + ')' + hp;
...
// Sync total = jumlah saat format
// Jalankan saat halaman load jika ada old value
window.onload = function() {
    const sel = document.getElementById('donaturSelect');
    if (sel.value) pilihDonatur();
};
</script>
