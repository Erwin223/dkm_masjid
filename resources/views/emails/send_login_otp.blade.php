...
<body>
    <div class="container">
        ...
        <p>Halo {{ $adminName }},</p>
        <p>Kami menerima permintaan login ke panel admin. Gunakan kode verifikasi berikut untuk melanjutkan login:</p>

        <div class="otp-box">
            {{ $otp }}
        </div>

        <p><em>Kode ini hanya berlaku selama 10 menit. Jika Anda tidak merasa melakukan login, abaikan email ini dan segera ganti password admin Anda.</em></p>
